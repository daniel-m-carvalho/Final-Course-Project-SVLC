...
public class HelloWorldController {
    ...
    public Map<String, String> helloWorld() throws UnknownHostException {
        return getResponse("Hello");
    }

    @GetMapping(path = "/goodbye", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public Map<String, String> goodbyeWorld() throws UnknownHostException {
        return getResponse("Goodbye");
    }

    private Map<String, String> getResponse(String message) throws UnknownHostException {
        String host = InetAddress.getLocalHost().getHostName();
        String ip = InetAddress.getLocalHost().getHostAddress();
        Map<String, String> response = new HashMap<>();
        response.put(MESSAGE_KEY, message + " World!");
